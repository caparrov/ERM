    ...
    for (Module::const_global_iterator I = M.global_begin(), E = M.global_end();
      ...
      if (!I->isDeclaration()) {
        ...
        if (void *SymAddr =
          ...
          // VCA: If the global hasn't been emitted to memory yet, allocate space
          // and emit it into memory.
          // if (I->hasAvailableExternallyLinkage()) {
#if HAVE___DSO_HANDLE
          dbgs() << "before Adding GlobalMapping dso_handle\n";
          if (I->getName() == "__dso_handle"){
            dbgs() << "Adding GlobalMapping dso_handle\n";
            addGlobalMapping( I, (void*)&__dso_handle);
          }else{
